                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="generateUniqueCodes()">GENERATE CODES</button>
...
function generateUniqueCodes() {
    ...
    function getUniqueCode() {
        let code;
        do {
            code = Math.floor(100 + Math.random() * 900).toString(); // Generates a 3-digit number
    ...
    inputs.forEach(input => {
        ...
        input.value = code;
        syncCode(input.id); // Also update the sample view
    });
}
</script>
